...
static const yytype_int8 yyrhs[] =
{
      ...
      -1,    14,    15,    -1,    15,    -1,    15,     5,    15,    -1,
      15,     6,    -1,    15,     7,    -1,    15,     8,    -1,    10,
      14,    11,    -1,     3,    -1,     4,    -1
};
...
{
  "$end", "error", "$undefined", "CHAR", "EMPTY", "'|'", "'*'", "'+'",
  "'?'", "';'", "'('", "')'", "$accept", "lines", "exprs", "expr", 0
};
#endif
...
{
       0,   256,   257,   258,   259,   124,    42,    43,    63,    59,
      40,    41
};
# endif
...
{
       2,     3,     4,     3,     4,     3,     4,    10,     6,     5,
       6,     9,     6,    16,     3,     4,     0,    11,     0,    11,
       0,     6,    17,    12,    13,    14,    15,    13,    14,    15
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,     3,     4,     9,    10,     9,
      10,     6,    10,    11,     3,     4,    -1,     7,    -1,     9,
      -1,    10,    12,     5,     6,     7,     8,     6,     7,     8
};
...
#line 65 "getDFA.y"
    { 
                ...
                mergeNFA(st , (yyvsp[(1) - (3)]), 0);
                mergeNFA(st , (yyvsp[(3) - (3)]), 0);
                mergeNFA(st , ed, -1);
                setEmptyTransition(st, (yyvsp[(1) - (3)])->num_states, (yyvsp[(1) - (3)])->num_states + (yyvsp[(3) - (3)])->num_states+1);
                (yyval) = st;
                free((yyvsp[(1) - (3)]));free((yyvsp[(3) - (3)]));free(ed);
            }
    break;
...
#line 77 "getDFA.y"
    { 
                ...
                initializeDFA(st,1,sym_maps_size);
                initializeDFA(ed,1,sym_maps_size);
                setEmptyTransition((yyvsp[(1) - (2)]), (yyvsp[(1) - (2)])->num_states -1, 0);
                mergeNFA(st , (yyvsp[(1) - (2)]), 0);
                mergeNFA(st , ed, -1);
                setEmptyTransition(st, 0, (yyvsp[(1) - (2)])->num_states +1);
                (yyval) = st;
                free((yyvsp[(1) - (2)]));free(ed);
            }
    break;
...
#line 121 "getDFA.y"
    { 
            int temp = (yyvsp[(1) - (1)])->start_state;
            initializeDFA((yyvsp[(1) - (1)]), 2 ,sym_maps_size);
            setEmptyTransition((yyvsp[(1) - (1)]), 0, 1);
            (yyval) = (yyvsp[(1) - (1)]);
            }
    break;
